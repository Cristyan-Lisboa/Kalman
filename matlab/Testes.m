...
axis([0 600 -5 5])
hold on
plot([0:1:600-1],saida8(1:600),'-','Color',1*[1 0 0],'LineWidth',3)
plot([0:1:600-1],saida9(1:600),'-','Color',1*[0 1 0],'LineWidth',2)
...
legend({'$y_k$','$\alpha = 1,2$','$\alpha = 1,0$','$\alpha = 0,95$'},'Interpreter','latex','Location','northeast','FontSize',22);

s = subplot(2,2,[2]);
l = 22;
a = 35;
stairs(f1,error1,'-','Color',1*[0 1 0],'LineWidth',1)
set(gca,'FontName','Arial')
set(gca,'FontSize',l)
set(gcf, 'Name', 'Dados do experimento')
ylabel('$S_e(f)$','Interpreter','latex','FontSize',a)
...
axis([0 0.5 0 0.2])
hold on
stairs(f1,error2,'-','Color',1*[1 0 0],'LineWidth',1)
%stairs(f1,error3,'-','Color',1*[0 0 1],'LineWidth',1)
hold off
box('on')
...
l = 22;
a = 35;
%stairs(f1,error1,'-','Color',1*[1 0 0],'LineWidth',3)
set(gca,'FontName','Arial')
set(gca,'FontSize',l)
set(gcf, 'Name', 'Dados do experimento')
ylabel('$S_e(f)$','Interpreter','latex','FontSize',a)
...
axis([0 0.5 0 1])
hold on
%stairs(f1,error1,'-','Color',1*[0 1 0],'LineWidth',2)
stairs(f1,error3,'-','Color',1*[0 0 1],'LineWidth',1)
